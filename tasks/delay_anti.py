        ...
        for i in range(batch_size):
            ...
            for period in range(self.num_periods):
                if period == 0:  # fixation period
                    ...
                    outputs[i, period*self.period_duration:(period+1)*self.period_duration, 2 - stimulus_on] = 1  # the chosen stimulus responds
        ...
        for stimulus_on in range(1, num_sequences + 1):
            ...
            for period in range(self.num_periods):
                if period == 0:  # fixation period
                    ...
                    outputs[stimulus_on - 1, period * self.period_duration:(period + 1) * self.period_duration, 2 - stimulus_on] = 1  # the chosen stimulus responds
